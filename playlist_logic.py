...
def lucky_pick(
    ...
    # Map mode to the playlist keys it should draw from, instead of
    # repeating playlists.get(...) in every branch.
    mode_keys = {"hype": ("Hype",), "chill": ("Chill",)}
    keys = mode_keys.get(mode, ("Hype", "Chill"))
